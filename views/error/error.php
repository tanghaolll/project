...
<meta charset="utf-8">
<title>404错误页面</title>
<link href="<?= UrlService::bulidWwwUrl("css/pintuer.css");?>" rel="stylesheet"/>
</head>
      ...
      <div class="text-center">
         ...
         <div class=""> 
            <div class="float-left">
                <img src="<?= UrlService::bulidWwwUrl("images/ds-1.gif");?>">
                <div class="alert"> 卧槽！页面不见了！ </div>
            </div>
            <div class="float-right">
               <img src="<?= UrlService::bulidWwwUrl("images/ds-2.png");?>" width="260"> 
            </div>
          </div>
